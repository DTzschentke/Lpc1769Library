...
/** @file		NL_LPC17xx_H_
	@date		2012-07-24
	@version	0.03
	@brief    	This header is needed for using the registers without pointers
  	@author		modified by Daniel Tzschentke
******************************************************************************/


#ifndef NL_NLPC17xx_H_
#define NL_NLPC17xx_H_
...
/* Bits added by DTZ */
//#define  - 	0  	// Reserved. NA
#define PCTIM0	1  	// Timer/Counter 0 power/clock control bit. 1
#define PCTIM1 	2  	// Timer/Counter 1 power/clock control bit. 1
#define PCUART0	3  	// UART0 power/clock control bit. 1
#define PCUART1	4  	// UART1 power/clock control bit. 1
//#define - 	5  	// Reserved. NA
#define PCPWM1 	6  	// PWM1 power/clock control bit. 1
#define PCI2C0 	7  	// The I2C0 interface power/clock control bit. 1
#define PCSPI 	8  	// The SPI interface power/clock control bit. 1
#define PCRTC 	9  	// The RTC power/clock control bit. 1
#define PCSSP1	10 	// The SSP 1 interface power/clock control bit. 1
//#define - 	11 	// Reserved. NA
#define PCADC 	12 	// A/D converter (ADC) power/clock control bit. 0
#define PCCAN1 	13 	// CAN Controller 1 power/clock control bit. 0
#define PCCAN2 	14 	// CAN Controller 2 power/clock control bit. 0
#define PCGPIO 	15 	// Power/clock control bit for IOCON, GPIO, and GPIO interrupts. 1
#define PCRIT 	16 	// Repetitive Interrupt Timer power/clock control bit. 0
#define PCMCPWM 17 	// Motor Control PWM 0
#define PCQEI 	18 	// Quadrature Encoder Interface power/clock control bit. 0
#define PCI2C1 	19 	// The I2C1 interface power/clock control bit. 1
//#define - 	20 	// Reserved. NA
#define PCSSP0 	21 	// The SSP0 interface power/clock control bit. 1
#define PCTIM2 	22 	// Timer 2 power/clock control bit. 0
#define PCTIM3 	23 	// Timer 3 power/clock control bit. 0
#define PCUART2 24 	// UART 2 power/clock control bit. 0
#define PCUART3 25 	// UART 3 power/clock control bit. 0
#define PCI2C2 	26 	// I2C interface 2 power/clock control bit. 1
#define PCI2S 	27 	// I2S interface power/clock control bit. 0
//#define - 	28 	// Reserved. NA
#define PCGPDMA 29 	// GPDMA function power/clock control bit. 0
#define PCENET 	30 	// Ethernet block power/clock control bit. 0
#define PCUSB 	31 	// USB interface power/clock control bit. 0
...
/*******************************************************************************
	Changelog
	2012-06-28	DTZ		PCONP Bit Names added
	2012-07-24	DTZ		renameing from ND_LPC17xx.h to nl_lpc17xx.h
*******************************************************************************/
